  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center px-8 py-14 md:hidden">
        <h1 className="mt-6 text-center font-sf text-[42px] font-bold leading-[38px] text-[#4B4B4B]">
          Take Financial
          <br />
          Control
        </h1>
        ...
        <p className="mt-14 max-w-[290px] text-center font-lato text-[18px] leading-[24px] text-[#4F4F4F]">
          Stay fit with easy transactions, no need for Digital Literacy,
          Unlimited Access, and Fast Response; you're done and get going...
        </p>

        <div className="mt-auto mb-6 w-full max-w-[320px] space-y-3">
          <Link
          ...
          <Link
            href="/login"
            className="flex h-[48px] w-full items-center justify-center gap-3 rounded-[10px] bg-white/30 font-sf text-[15px] font-bold text-[#2E8B57] backdrop-blur-sm"
          >
            <Sparkles size={16} />
            Skip
            <LogIn size={17} />
