        ...
        <footer className="bg-[#7DB99A] px-5 py-8 text-[#1F1F1F]">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="mx-auto max-w-3xl text-sm leading-5">
              ZentraBank is a complete e-Banking system. We provide secure
              digital tools for subscriptions, virtual cards, transfers, account
              activity, notifications, and customer support.
            </p>
