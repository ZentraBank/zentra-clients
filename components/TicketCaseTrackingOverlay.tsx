...
const helpItems = [
  {
    ...
    href: "/support/help-center/view-submitted-complaints",
  },
  {
    title: "Ticket Status (Pending/Resolved)",
    href: "/support/help-center/ticket-status",
  },
  {
    title: "Chat on  Existing Tickets",
    href: "/support/help-center/chat-on-existing-tickets",
  },
//   {
...
type TicketCaseTrackingOverlayProps = {
  open: boolean;
  onClose: () => void;
};

export default function TicketCaseTrackingOverlay({
  open,
  onClose,
}: TicketCaseTrackingOverlayProps) {
  if (!open) return null;
